 ...
 * @author Todd Elvers
 */
public class TemplateWindowtemp extends javax.swing.JDialog {



    /** Creates new form StartupWindowTemp */
    public TemplateWindowtemp(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        slideOption1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TitleSlide.png"))); // NOI18N
        ...
        slideOption2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BulletedSlide.png"))); // NOI18N
        ...
        slideOption3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DrawingSlide.png"))); // NOI18N
        slideOption3.setIconTextGap(20);
        slideOption3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                slideOption3ActionPerformed(evt);
            }
        });
...
private void slideOption3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_slideOption3ActionPerformed
// TODO add your handling code here:
}//GEN-LAST:event_slideOption3ActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                TemplateWindowtemp dialog = new TemplateWindowtemp(new javax.swing.JFrame(), true);
    ...
    private URL logo = ClassLoader.getSystemResource("logo.png");
    private URL titleSLide = ClassLoader.getSystemResource("TitleSlide.png");
    private URL bulletSLide = ClassLoader.getSystemResource("BulletedSlide.png");
    private URL drawnSlide = ClassLoader.getSystemResource("DrawingSlide.png");
    
    private ImageIcon icon = new ImageIcon(logo);
